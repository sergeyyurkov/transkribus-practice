...
using TranskribusPractice.ViewModels.ImplementationsNetFramework.Commands;
...
namespace TranskribusPractice.ViewModels.ImplementationsNetFramework
{
    public partial class ViewModelImpl
    {
        ...
        private RelayCommand<KeyEventArgs> _deleteSelectedRectangleCommand;
        #endregion
        #region properties
        ...
        public override ICommand DeleteSelectedRectangleCommand
        {
            get => _deleteSelectedRectangleCommand ??
                  (_deleteSelectedRectangleCommand = new RelayCommand<KeyEventArgs>(e =>
                  {
                      if (e.Key == Key.Delete || e.Key == Key.Back)
                      {
                          DeleteSelectedRectangleExecution();
                      }
                  }));
        }
        #endregion
        #region private methods
        private void DeleteSelectedRectangleExecution()
        {
        ...
        private TextRegion DefineParentText()
        {
        ...
        private LineRegion DefineParentLine() 
        {
        ...
        public void RectangleMouseDown(double x, double y)
        {
