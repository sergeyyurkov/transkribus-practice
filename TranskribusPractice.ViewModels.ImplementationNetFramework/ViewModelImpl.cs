...
namespace TranskribusPractice.ViewModels.ImplementationsNetFramework
{
    public partial class ViewModelImpl : AbstractViewModel, IMouseAware
    {
        ...
        private RelayCommand<CancelEventArgs> _ClosingWindowCommand;
        ...
        public override ICommand ClosingWindowCommand
        {
              get => _ClosingWindowCommand ??
                    (_ClosingWindowCommand = new RelayCommand<CancelEventArgs>(ClosingWindowCommandExecution));
        }
        ...
        private void ClosingWindowCommandExecution(CancelEventArgs e) 
        {
            var projectService = (IProjectService)_serviceProvider.GetService(typeof(IProjectService));
            if (!IsSaved())
            {
